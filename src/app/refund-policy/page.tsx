...
const title = "Refund & Dispute Policy | Cashlo";
const description = "How Cashlo handles refunds, reversals, cancellations and transaction disputes across its services.";
