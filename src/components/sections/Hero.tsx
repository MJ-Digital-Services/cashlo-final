...
const avatars: {
  ...
  { id: "photo", image: "/avatars/avatar-1.png" },
  { id: "pv", label: "PV", className: "bg-emerald-500" },
  { id: "photo", image: "/avatars/avatar-3.png" },
];

export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#F9F4F4]">
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-6 px-6 pb-20 pt-32 lg:grid-cols-[1fr_1.05fr] lg:gap-4 lg:px-8 lg:pt-40">
        {/* Left column */}
